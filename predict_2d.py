...
config['save_prediction_path'] = 'prediction_labels'
...
test_images = pre.correction_label(test_images)
...
print('Save images...')
np.save("%s_%s_%s.npy" % (args.data, config['view'], config['norm_axis']), test_images.astype(np.uint8))
